export const UiHelperUtil = {
    ...
    getTruncateString(string, chars, truncate) {
        ...
        return `${string.substring(0, Math.floor(chars / 2))}...${string.substring(string.length - Math.floor(chars / 2))}`;
    },
...
//# sourceMappingURL=UiHelperUtils.js.map
...
import { ADD_CHAIN_METHOD, EIP6963_ANNOUNCE_EVENT, EIP6963_CONNECTOR_ID, EIP6963_REQUEST_EVENT, NAMESPACE, VERSION, WALLET_CHOICE_KEY, WALLET_CONNECT_CONNECTOR_ID } from './utils/constants.js';
...
export class Web3Modal extends Web3ModalScaffold {
    ...
    listenConnectors(connectors) {
        const connector = connectors.find(c => c.id === EIP6963_CONNECTOR_ID);
